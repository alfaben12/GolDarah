...
<html lang="en">
  ...
  <head>
    ...
    <title>APLIKASI PENENTUAN GOL DARAH</title>
  ...
  <body>
    ...
    <nav id="sidebar-wrapper">
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-brand">
          <a class="js-scroll-trigger" href="#top">Mulai Test</a>
        </li>
        <li>
          <a class="js-scroll-trigger" href="#top">Home</a>
        </li>
        <li>
          <a class="js-scroll-trigger" href="#about">Test Gol</a>
        </li>
	    <li>
    ...
    <header class="header" id="top">
      <div class="text-vertical-center">
        <h1>QUICK TEST GOLONGAN DARAH</h1>
        <h3>Menurut sifat dan karakter Manusia</h3>
        <br>
        <a href="#services"" class="btn btn-dark btn-lg js-scroll-trigger">Lanjut Test</a>
      </div>
    </header>
    ...
    <section id="about" class="about">
      <div class="container text-center">
        <h2>Jawablah pertanyaan-pertanyaan dibawah menurut sifat dan kelakuan Anda</h2>
      ...
      <div class="container" id="contact">
        <div class="row">
          <div class="col-lg-10 mx-auto text-center">
            <h4>
              <strong>Reza Rizqullah</strong>
            </h4>
            <p>Blang Jruen
              <br>Aceh, Tanah Luas 24385</p>
            <ul class="list-unstyled">
              ...
              <li>
                ...
                <a href="mailto:name@example.com">android.ac3h@gmail.com</a>
              </li>
            </ul>
            <br>
            ...
            <hr class="small">
            <p class="text-muted">Copyright &copy; Golongan Darah 2017</p>
          </div>
        </div>
      </div>
